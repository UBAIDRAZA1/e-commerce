...
export default function FeaturedProductComponent() {
  ...
  const [selectedProduct, setSelectedProduct] = useState<any | null>(null); // State for selected product details modal
  ...
  const products = [
    {
      ...
      price: 2000,
      description: 'Comfortable library stool chair with ergonomic design, made from high-quality wood and steel. Perfect for libraries, offices, and homes.',
    ...
    },
    {
      ...
      name: 'Study Chair',
      price: 1500,
      description: 'Perfect study chair with padded seat and adjustable height, designed for long study sessions.',
    ...
    },
    {
      ...
      name: 'Recliner Chair',
      price: 3000,
      description: 'Luxurious recliner chair for ultimate relaxation. Comes with a built-in footrest and adjustable reclining positions.',
      material: 'Leather and Metal',
      dimensions: '24x30x40 inches',
      weight: '15 kg',
    },
    {
      ...
      name: 'Dining Chair',
      price: 1800,
      description: 'Elegant dining chair made of premium wood and fabric. Ideal for modern dining setups.',
      material: 'Wood and Fabric',
      dimensions: '18x18x35 inches',
      weight: '7 kg',
    },
  ];
