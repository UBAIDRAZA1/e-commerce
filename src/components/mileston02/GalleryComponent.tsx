...
const ChairGallery = () => {
  const chairImages = [
    { src: "/milestone2/chair3.png", alt: "Main Chair", main: true },
    { src: "/milestone2/chair2.png", alt: "Chair 2", main: false },
    { src: "/milestone2/chair.png", alt: "Chair 3", main: false },
    { src: "/milestone2/chair4.png", alt: "Chair 4", main: false },
    { src: "/milestone2/card.png", alt: "Chair 5", main: false }
  ];
