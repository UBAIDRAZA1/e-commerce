...
const targetClient = createClient({
  projectId: NEXT_PUBLIC_SANITY_PROJECT_ID || "zopagwjj", // Your Sanity project ID
  ...
  token: NEXT_PUBLIC_SANITY_AUTH_TOKEN || "skGZ5HSuK6flNFBhMMpuAniMdj5rUEROADJz1HVIGwvjg6MMXJweSaf0PzO5CCJyjV6HhxPmqRcbVeqoQ6lBLxLFb9sm68X1VWLJZ4beZJPoSoISbMfWDyl9ZQKW98TO3sbVY35OzObTfFP75D090KVUUKYGZquRD05NWCKEGoP8LyJUzJyq", // API token for authentication
});
